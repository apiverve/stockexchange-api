// Package stockexchange provides a Go client for the Stock Exchange API.
//
// For more information, visit: https://apiverve.com/marketplace/stockexchange?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/stockexchange"
	defaultTimeout = 30 * time.Second
)

// Client is the Stock Exchange API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Stock Exchange API client.
...
// Execute makes a request to the Stock Exchange API with typed parameters.
//
...
//   - mic (required): string - The 4-character Market Identifier Code (e.g., XNYS for NYSE, XNAS for NASDAQ) [minLength: 4, maxLength: 4]
