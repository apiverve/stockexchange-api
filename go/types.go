...
// Request contains the parameters for the Stock Exchange API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"mic": {Type: "string", Required: true, MinLength: intPtr(4), MaxLength: intPtr(4)},
	}
...
// ResponseData contains the data returned by the Stock Exchange API.
