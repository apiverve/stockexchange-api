...
{
    class StockExchangeExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/stockexchange";

        /// <summary>
        /// Make a GET request to the Stock Exchange API
        /// </summary>
        static async Task<JsonDocument> CallStockExchangeAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;mic&quot;] &#x3D; &quot;XNYS&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Stock Exchange API...\n");

            var result = await CallStockExchangeAPI();
