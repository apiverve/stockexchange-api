...
namespace APIVerve.API.StockExchange
{
    ...
    /// <summary>
    /// Client for the StockExchange API
    /// </summary>
    public class StockExchangeAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/stockexchange";
        ...
        {
            { "mic", new ValidationRule { Type = "string", Required = true, MinLength = 4, MaxLength = 4 } }
        };
        ...
        public StockExchangeAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public StockExchangeAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public StockExchangeAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, StockExchangeQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(StockExchangeQueryOptions options)
        {
        ...
        public ResponseObj Execute(StockExchangeQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(StockExchangeQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(StockExchangeQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(StockExchangeQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(StockExchangeQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(StockExchangeQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(StockExchangeQueryOptions options)
        {
